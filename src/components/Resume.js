                    ...
                    <Cell className="resume-grid-cell"col={12}>
                      ...
                      <p className="resume-content-profile">
                        ...
                        <section className="resume-content-experience">
                            ...
                            <img src={iconLeader} alt="icono de lider" ></img><h4>Service Desk Co.Manager.</h4>  
                            </div>
...
My main objectives and activities were to develop and implement technological solutions through the Servicenow tool that allowed to automate and improve activities within the processes of incidents, requests and events, these solutions were focused both for internal users and for the areas of IT support .</p>
                            ...
                            <div className="container-titles">
                            <img src={iconManager} alt="icono de manager"></img><h4>Service Desk Project Leader.</h4>  
                            </div>
                            
                            <p>
                            Coordinate and supervise the activities of telephone operators in the Servicedesk to obtain and fulfill objectives. Responsible for the attention to critical and high impact incidents. Review of SLA ́s with service providers and OLA ́s with second level support areas. Creation and execution of continuous improvement plans for operators to increase their productivity. Generate and coordinate schedules. Call monitoring of telephone operators. Preparation and review of logbooks of events and daily executive reports.</p>    
                        </section>
